...
void Inclinometer::mat_add(const double *m1, const double *m2, double *sol, const int& row, const int& column)
{
  for(int i=0; i<row; i++){
...
inline void Inclinometer::mat_sub(const double *m1, const double *m2, double *sol, const int& row, const int& column)
{
  for(int i=0; i<row; i++){
    for(int j=0; j<column; j++){
      sol[i*column + j] = m1[i*column + j] - m2[i*column + j];
...
inline void Inclinometer::mat_mul(const double *m1, const double *m2, double *sol, const int row1, const int column1, const int row2, const int column2)
{
...
inline void Inclinometer::mat_tran(const double *m1, double *sol, const int& row_original, const int& column_original)
{
...
inline void Inclinometer::mat_mul_const(const double *m1, const double& c, double *sol, const int& row, const int& column)
{
  for(int i=0; i<row; i++){
    for(int j=0; j<column; j++){
...
inline void Inclinometer::mat_inv(const double *m, double *sol, const int& column, const int& row)
{
